...
def face_function():
    img = [f for f in os.listdir("images") if fnmatch.fnmatch(f, '*.jpg')]
    ...
    known_face_names = []
    for i in img:
        i_image = face_recognition.load_image_file("images/" + i)
        name = face_recognition.face_encodings(i_image)[0]
